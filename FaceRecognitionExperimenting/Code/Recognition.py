...
def Recognition():
    ...
    robertdowney_image = face_recognition.load_image_file("robertdowney.jpg")
    robertdowney_face_encodings = face_recognition.face_encodings(robertdowney_image) [0]

    favreau_image = face_recognition.load_image_file("favreau.jpg")
    favreau_face_encodings = face_recognition.face_encodings(favreau_image) [0]

    Mickey_image = face_recognition.load_image_file("Mickey.jpg")
    ...
    Gwyneth_image = face_recognition.load_image_file("Gwyneth.jpg")
    Gwyneth_face_encodings = face_recognition.face_encodings(Gwyneth_image) [0]

    Don_image = face_recognition.load_image_file("Don.jpg")
    ...
    image = face_recognition.load_image_file("2obamas.jpg")
    ...
    for(top,right,bottom,left), face_encodings in zip(face_locations,face_encodings):
        ...
        font = ImageFont.truetype("LEMONMILK-Regular.otf",12)
